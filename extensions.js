// extensions.js - VERSION STABLE (PRÉCÉDENTE)
// Bio-Recycleur V2 (Standard), Marge Santé OK, Cloud OK.
...
function injectExtensionContainers() {
    ...
    if (!document.getElementById('recycler-widget-container')) {
        ...
        const chart = dashboard.querySelector('.chart-card'); 
        if(chart) chart.insertAdjacentElement('afterend', div);
        else dashboard.appendChild(div); // Fallback si pas de graph
    }

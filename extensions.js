...
// ==========================================
// 1. BIO-RECYCLEUR V3 (PAIN + COMPOST)
// ==========================================
function renderRecyclerWidget() {
    ...
    container.innerHTML = `
        <div class="glass-card" style="background:linear-gradient(to right, rgba(255,255,255,0.8), rgba(200, 255, 200, 0.4)); border:1px solid rgba(52, 199, 89, 0.2);">
            ...
            <div style="margin-top:15px; margin-bottom:5px; font-size:10px; color:var(--success); font-weight:800; text-transform:uppercase; letter-spacing:0.5px;">♻️ Compost (Boîte)</div>
